...
[ExecuteInEditMode]
public class DefeatScreenDisplay : MonoBehaviour
{
    ...
    private void Update() {
        ...
        string textToShow = "ERROR 108: *** CHASSIS INTEGRITY FAILURE ***\n\nCrash Dump:\n";
        ...
        if(robot.state.isDead && !container.gameObject.activeSelf) {
