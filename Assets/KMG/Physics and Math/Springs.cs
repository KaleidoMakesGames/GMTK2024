...
namespace KMGPhysics {
    public static class Springs {
        ...
        public static void ComputeMassSpringDamper(ref Vector2 x, ref Vector2 v, Vector2 xGoal, DampedSpringSettings settings, float? dt = null) {
            Vector3 x_2 = x;
            Vector3 v_2 = v;
            ComputeMassSpringDamper(ref x_2, ref v_2, xGoal, settings, dt);
            x = x_2;
            v = v_2;
        }
